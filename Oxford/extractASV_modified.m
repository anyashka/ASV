...
threshold = ThresholdType.Median % Modified type of thresholding
...
for i = 1:8
    for j = 1:6
        ...
        d_asv = vl_asvcovdet_modified(im1, opt, f, des, isInter, threshold);
        ...
        save([nameF,'/ASV',char(threshold)],'f','d_asv', 'opt')
        t = toc;
